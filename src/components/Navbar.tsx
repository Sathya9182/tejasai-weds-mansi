    ...
    <header className="sticky top-0 z-40 bg-white/95 backdrop-blur-md border-b border-zinc-200">
      <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 sm:h-20">
          ...
          <a
            href="#"
            className="group flex items-center gap-1.5 sm:gap-2 text-xl sm:text-2xl md:text-3xl font-serif-luxury tracking-wide text-zinc-950 hover:text-purple-600 transition-colors shrink-0"
          >
            <span className="font-semibold">Teja Sai</span>
            <span className="inline-block relative">
              <Heart className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-pink-500 fill-pink-500 inline-block animate-pulse" />
          ...
          {/* Zone 3: Actions + Language Toggle + Host Portal */}
          <div className="flex items-center gap-1.5 sm:gap-2.5">
            {/* Language toggle */}
            <button
              onClick={onToggleLang}
              className="px-2 py-1.5 sm:px-2.5 sm:py-1.5 text-xs font-medium text-zinc-700 hover:text-zinc-950 hover:bg-pink-50 rounded-md transition-colors flex items-center gap-1 border border-zinc-200"
              title="Toggle Telugu / English"
            >
              <Globe className="w-3.5 h-3.5 text-purple-600" />
              <span className="uppercase text-[10px] sm:text-[11px] font-semibold tracking-wider">
                {currentLang === 'te' ? 'EN' : 'తెలుగు'}
              </span>
            </button>
            ...
            <button
              ...
              className="relative p-1.5 sm:p-2 text-zinc-700 hover:text-zinc-950 hover:bg-purple-50 rounded-full transition-colors"
            ...
            <button
              onClick={onOpenRSVP}
              className="px-2.5 py-1.5 sm:px-4 sm:py-2 text-[11px] sm:text-xs font-semibold uppercase tracking-wider text-white bg-gradient-to-r from-pink-500 via-purple-600 to-indigo-600 hover:from-pink-600 hover:via-purple-700 hover:to-indigo-700 rounded-md shadow-xs hover:shadow-md transition-all whitespace-nowrap"
            >
              RSVP
            </button>
            ...
            <button
              ...
              className="lg:hidden p-1.5 text-zinc-700 hover:text-zinc-950 rounded-md"
