    ...
    <section id="events" className="py-16 md:py-24 bg-zinc-50/60 border-t border-zinc-200">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-5xl mx-auto">
          ...
          <div className="bg-white rounded-2xl p-6 sm:p-8 border border-zinc-200 shadow-sm hover:shadow-md transition-shadow relative flex flex-col justify-between">
            ...
            <div className="flex flex-wrap items-center gap-2 pt-6 mt-6 border-t border-zinc-100">
              <button
                ...
                className="px-3.5 py-2 text-xs font-semibold text-zinc-800 bg-zinc-100 hover:bg-zinc-200 border border-zinc-200 rounded-lg transition-colors inline-flex items-center gap-1.5"
              >
              ...
              <button
                onClick={onOpenRSVP}
                className="px-3.5 py-2 text-xs font-semibold text-white bg-gradient-to-r from-pink-500 to-purple-600 hover:from-pink-600 hover:to-purple-700 rounded-lg transition-all ml-auto shadow-2xs"
              >
                RSVP for Reception
              </button>
            </div>
          ...
          {/* EVENT 2: SUMUHURTHAM */}
          <div className="bg-white rounded-2xl p-6 sm:p-8 border-2 border-purple-300 shadow-sm hover:shadow-md transition-shadow relative flex flex-col justify-between">
            <div className="absolute top-0 right-0 transform translate-x-2 -translate-y-2">
              <span className="inline-flex items-center gap-1 px-3 py-1 bg-purple-50 border border-purple-300 text-purple-800 text-[11px] font-bold uppercase tracking-wider rounded-full shadow-2xs">
            ...
            <div className="flex flex-wrap items-center gap-2 pt-6 mt-6 border-t border-zinc-100">
              ...
              <button
                onClick={onOpenRSVP}
                className="px-3.5 py-2 text-xs font-semibold text-white bg-gradient-to-r from-pink-500 via-purple-600 to-indigo-600 hover:from-pink-600 hover:to-purple-700 rounded-lg transition-all ml-auto shadow-2xs"
              >
                RSVP for Ceremony
              </button>
            </div>
